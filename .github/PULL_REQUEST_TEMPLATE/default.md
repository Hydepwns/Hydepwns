...
<!-- Reference any related issues with # syntax, e.g., "Fixes #123" -->
...
- [ ] Any code examples in documentation have been tested

### Scripts & Tools

- [ ] I have placed any new scripts in the appropriate `scripts/` subdirectory
- [ ] I have made scripts executable with appropriate permissions (`chmod +x`)
- [ ] I have updated the scripts README.md if adding new scripts
- [ ] I have added header comments with usage instructions for new scripts
- [ ] I have created dedicated documentation for complex scripts using the template
- [ ] I have validated any new scripts work as expected
