...
```
test/hydepwns_liveview_web/integration/
...
```bash
# Run all integration tests
mix test test/hydepwns_liveview_web/integration/

# Run specific test file
mix test test/hydepwns_liveview_web/integration/api_integration_test.exs

# Run with coverage
mix test test/hydepwns_liveview_web/integration/ --cover

# Run with trace output
mix test test/hydepwns_liveview_web/integration/ --trace
```
...
```elixir
# config/test.exs
config :hydepwns_liveview, :test_mode, true
...
config :hydepwns_liveview, :email_service, HydepwnsLiveview.MockEmailService
config :hydepwns_liveview, :sms_service, HydepwnsLiveview.MockSMSService
```
