...
This guide explains how to set up and use the monitoring system for HydepwnsLiveview.
...
1. Add the metric to the telemetry handler in `lib/hydepwns_liveview/events/core/event_monitor/telemetry.ex`
