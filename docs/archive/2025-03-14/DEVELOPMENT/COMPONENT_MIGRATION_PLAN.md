...
3. **Implementation**
   - Convert to a class-based component following the [Component Migration Guide](../../assets/js/components/COMPONENT_MIGRATION_GUIDE.md) <!-- TODO: Fix broken link -->
...
- [Component Migration Guide](../../assets/js/components/COMPONENT_MIGRATION_GUIDE.md) <!-- TODO: Fix broken link -->
