...
**Please visit the new document location**: [development/integration/liveview-component-integration.md](../../development/integration/liveview-component-integration.md)
