...
> The current version of this document is now at [project/roadmap.md](../../project/roadmap.md).
...
**Please visit the new document location**: [project/roadmap.md](../../project/roadmap.md)
...
1. **Documentation and Planning** ✅ COMPLETED
   - [x] [Component Migration Guide](../../assets/js/components/COMPONENT_MIGRATION_GUIDE.md) <!-- TODO: Fix broken link --> with step-by-step instructions
