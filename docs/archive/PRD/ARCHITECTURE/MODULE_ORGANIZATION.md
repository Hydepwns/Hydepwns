...
This document provides information about MODULE ORGANIZATION.
...
**Please visit the new document location**: [reference/architecture/modules.md](../../reference/architecture/modules.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->

## Automatic Redirect

You will be automatically redirected to the new location in 5 seconds.

<meta http-equiv="refresh" content="5;url=../../reference/architecture/modules.md" />
