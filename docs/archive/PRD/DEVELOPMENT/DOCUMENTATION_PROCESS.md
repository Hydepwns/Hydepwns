...
**Please visit the new document location**: [project/documentation/process.md](../../project/documentation/process.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->
...
2. **Structure**: Plan the document structure according to the [Style Guide](../../STYLE_GUIDE.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->.
...
5. **Style**: Writing should adhere to the [Style Guide](../../STYLE_GUIDE.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->.
...
- [Documentation Style Guide](../../STYLE_GUIDE.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->
