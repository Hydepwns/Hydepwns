---
title: Component Migration Project Summary
description: >-
...
Detailed performance measurements for all components are available in the [performance reports directory](../../js/performance/reports/) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->.

### Appendix C: Testing Coverage

Unit test coverage reports are available in the [coverage directory](../../coverage/lcov-report/index.html) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->. 
