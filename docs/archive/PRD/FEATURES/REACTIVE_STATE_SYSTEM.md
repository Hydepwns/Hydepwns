...
**Please visit the new document location**: [reference/architecture/reactive-state.md](../../reference/architecture/reactive-state.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->
