...
**Please visit the new document location**: [development/tools/terminal-plugins.md](../../development/tools/terminal-plugins.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->

## Automatic Redirect

You will be automatically redirected to the new location in 5 seconds.

<meta http-equiv="refresh" content="5;url=../../development/tools/terminal-plugins.md" />
