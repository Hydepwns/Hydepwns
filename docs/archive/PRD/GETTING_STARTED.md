...
description: >-
  ...
  [guides/getting-started/index.md](../guides/getting-started/index.md).
topics:
  - prd
  - '-documentation-moved-'
  - main-content
...
> The current version of this document is now at [guides/getting-started/index.md](../guides/getting-started/index.md).
...
**Please visit the new document location**: [guides/getting-started/installation.md](../../guides/getting-started/installation.md) <!-- TODO: Fix broken link --> <!-- TODO: Fix broken link -->

## Automatic Redirect

You will be automatically redirected to the new location in 5 seconds.

<meta http-equiv="refresh" content="5;url=../../guides/getting-started/installation.md" />
