...
This document provides information about RESOURCE SYSTEM IMPLEMENTATION.
...
**Please visit the new document location**: [../docs/reference/architecture/resource-system.md](reference/architecture/resource-system.md) <!-- TODO: Fix broken link -->

## Automatic Redirect

You will be automatically redirected to the new location in 5 seconds.

<meta http-equiv="refresh" content="5;url=../../docs/reference/architecture/resource-system.md" />
...
The admin interface provides a comprehensive dashboard for managing resources:
