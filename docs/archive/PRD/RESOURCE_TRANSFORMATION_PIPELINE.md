...
This document provides information about RESOURCE TRANSFORMATION PIPELINE.
...
**Please visit the new document location**: [../docs/reference/architecture/transformation-pipeline.md](reference/architecture/transformation-pipeline.md) <!-- TODO: Fix broken link -->

## Automatic Redirect

You will be automatically redirected to the new location in 5 seconds.

<meta http-equiv="refresh" content="5;url=../../docs/reference/architecture/transformation-pipeline.md" />
