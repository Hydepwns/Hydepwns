...
# Relevant aliases
alias HydepwnsLiveview.Transformations.TransformationRegistry # The GenServer based registry
# alias HydepwnsLiveview.Resources.UserResource # Example resource
# alias HydepwnsLiveview.Context                # Example context
...
IO.puts("Please refer to HydepwnsLiveview.Transformations.TransformationRegistry for the current API.")
...
# HydepwnsLiveview.Transformations.TransformationRegistry.register(
...
IO.puts("transformations = HydepwnsLiveview.Transformations.TransformationRegistry.get_transformations(:user, :update, :before_validation)")
...
# alias HydepwnsLiveview.Transformations.NormalizeEmail # Old alias
# alias HydepwnsLiveview.Transformations.GenerateUsername # Old alias
