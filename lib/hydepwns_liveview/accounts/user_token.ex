defmodule HydepwnsLiveview.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, HydepwnsLiveview.Accounts.User
  ...
  def generate_session_token(user) do
    ...
    {token, %HydepwnsLiveview.Accounts.UserToken{token: token, context: "session", user_id: user.id}}
  end
  ...
  @doc """
  Deletes all tokens for the given user and contexts.
  """
