defmodule HydepwnsLiveview.Events.EventSettings do
  use Ecto.Schema
  ...
  def changeset(settings, attrs) do
    settings
    |> cast(attrs, [:timezone, :default_status, :default_duration, :max_events_per_day, :enable_reminders, :reminder_time, :event_id])
    |> validate_required([:timezone, :default_status, :default_duration, :max_events_per_day, :event_id])
    |> validate_inclusion(:timezone, HydepwnsLiveview.Events.list_timezones())
