defmodule HydepwnsLiveview.Events.ProjectionProcess do
  @moduledoc """
  Bridge module for the Projection Process.

  This module delegates to HydepwnsLiveview.Events.Projections.ProjectionProcess,
  ...
  alias HydepwnsLiveview.Events.Projections.ProjectionProcess, as: CoreProjectionProcess
