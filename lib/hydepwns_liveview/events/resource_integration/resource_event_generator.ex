defmodule HydepwnsLiveview.Events.ResourceIntegration.ResourceEventGenerator do
  ...
  This module delegates to HydepwnsLiveview.Events.ResourceEventGenerator,
  ...
  alias HydepwnsLiveview.Events.ResourceEventGenerator, as: CoreResourceEventGenerator
