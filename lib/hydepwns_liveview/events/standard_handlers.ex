defmodule HydepwnsLiveview.Events.StandardHandlers do
  @moduledoc """
  Bridge module for the Standard Handlers.

  This module delegates to HydepwnsLiveview.Events.Handlers.StandardHandlers,
  ...
  alias HydepwnsLiveview.Events.Handlers.StandardHandlers, as: CoreStandardHandlers
