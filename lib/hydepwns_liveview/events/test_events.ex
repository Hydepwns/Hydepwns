defmodule HydepwnsLiveview.Events.TestEvents do
  @moduledoc """
  Bridge module for the Test Events.

  This module delegates to HydepwnsLiveview.Events.Core.TestEvents,
  ...
  alias HydepwnsLiveview.Events.Core.TestEvents, as: CoreTestEvents
