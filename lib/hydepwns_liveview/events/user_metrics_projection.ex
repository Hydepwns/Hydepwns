defmodule HydepwnsLiveview.Events.UserMetricsProjection do
  @moduledoc """
  Bridge module for the User Metrics Projection.

  This module delegates to HydepwnsLiveview.Events.Projections.UserMetricsProjection,
  ...
  alias HydepwnsLiveview.Events.Projections.UserMetricsProjection, as: CoreUserMetricsProjection
