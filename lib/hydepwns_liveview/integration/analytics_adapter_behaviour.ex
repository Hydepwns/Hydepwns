defmodule HydepwnsLiveview.Integration.AnalyticsAdapterBehaviour do
  @moduledoc """
  ...
  @callback track_user_action(String.t(), String.t(), map()) :: {:ok, String.t()} | {:error, term()}
  ...
  @callback get_analytics_data(DateTime.t(), DateTime.t(), map()) :: {:ok, map()} | {:error, term()}
end
