defmodule HydepwnsLiveview.Resources.ModerationNoteResource do
  @moduledoc """
  ...
  belongs_to(:comment, HydepwnsLiveview.Resources.CommentResource, foreign_key: :comment_id)
  belongs_to(:moderator, HydepwnsLiveview.Resources.UserResource, foreign_key: :moderator_id)
