defmodule HydepwnsLiveview.Resources.TestExampleUserResource do
  @moduledoc """
  ...
  def create_events(id, params) do
    ...
    {:ok, [
      %{type: "user.created", data: params, resource_id: resource_id, resource_type: resource_type()}
    ]}
  end
  ...
  def create_update_events(resource, params) do
    ...
    [
      %{type: "user.updated", data: params, resource_id: resource_id, resource_type: resource_type()}
    ]
  end
