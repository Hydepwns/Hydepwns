defmodule HydepwnsLiveview.Resources.TestTeamResource do
  @moduledoc """
  ...
  def create_events(id, params) do
    ...
    {:ok, [
      %{type: "team.created", data: params, resource_id: resource_id, resource_type: resource_type()}
    ]}
  end
  ...
  def create_update_events(resource, params) do
    ...
    [
      %{type: "team.updated", data: params, resource_id: resource_id, resource_type: resource_type()}
    ]
  end
