defmodule HydepwnsLiveview.Resources.CacheServer do
  ...
  * `{:error, reason}` - Failed to warm up resource
  ...
  defp get_warmup_function(resource_type) do
    ...
    warmup_functions = %{
      :user => &HydepwnsLiveview.Resources.UserResource.load/1,
      :post => &HydepwnsLiveview.Resources.PostResource.load/1,
      :team => &HydepwnsLiveview.Resources.TeamResource.load/1,
      :comment => &HydepwnsLiveview.Resources.CommentResource.load/1,
      :category => &HydepwnsLiveview.Resources.CategoryResource.load/1
    }
