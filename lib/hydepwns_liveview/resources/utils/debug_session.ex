defmodule HydepwnsLiveview.Resources.DebugSession do
  @moduledoc """
  ...
  * `{:error, reason}` - The event handling failed
  ...
  defp subscribe_to_resource_events(resource_type, resource_id, session_id) do
    ...
    HydepwnsLiveview.Events.EventBus.subscribe(pid, topic)

    # Also subscribe to general resource events
    general_topic = "resource:#{resource_type}"
    HydepwnsLiveview.Events.EventBus.subscribe(pid, general_topic)
  ...
  defp get_resource_module(resource_type) do
    ...
    resource_modules = %{
      "user" => HydepwnsLiveview.Resources.User,
      "post" => HydepwnsLiveview.Resources.Post,
      "comment" => HydepwnsLiveview.Resources.Comment,
      "project" => HydepwnsLiveview.Resources.Project,
      "task" => HydepwnsLiveview.Resources.Task
    }
  ...
  defp notify_breakpoint_hit(session_id, event, breakpoints) do
    ...
    Phoenix.PubSub.broadcast(HydepwnsLiveview.PubSub, "debug:#{session_id}", notification)
