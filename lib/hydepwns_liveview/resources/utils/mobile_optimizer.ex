defmodule HydepwnsLiveview.Resources.MobileOptimizer do
  @moduledoc """
  ...
  * CSS string with mobile optimization styles
  ...
  defp display_config_for_mode(:touch_compact) do
    %{
      max_title_length: 40,
      max_description_length: 80,
      image_size: :thumbnail,
  ...
  defp display_config_for_mode(:touch) do
    %{
      max_title_length: 60,
      max_description_length: 120,
      image_size: :small,
  ...
  defp display_config_for_mode(:compact) do
    %{
      max_title_length: 80,
      max_description_length: 160,
      image_size: :medium,
  ...
  defp display_config_for_mode(_) do
    %{
      max_title_length: 100,
      max_description_length: 200,
      image_size: :large,
