defmodule HydepwnsLiveview.Resources.PerformanceMeasurer do
  @moduledoc """
  ...
  def measure_batch(operations, opts \\ []) do
    ...
    :telemetry.execute(
      [:hydepwns_liveview, :resources, :batch, :stop],
      batch_metrics,
  ...
  def register_telemetry_handlers do
    handlers = [
      {"resource-performance-handler", [:hydepwns_liveview, :resources, :operation, :stop], &handle_resource_operation_telemetry/4},
      {"resource-performance-start-handler", [:hydepwns_liveview, :resources, :operation, :start], &handle_resource_start_telemetry/4},
      {"resource-performance-exception-handler", [:hydepwns_liveview, :resources, :operation, :exception], &handle_resource_exception_telemetry/4},
      {"resource-batch-handler", [:hydepwns_liveview, :resources, :batch, :stop], &handle_batch_telemetry/4}
    ]
