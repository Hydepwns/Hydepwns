defmodule HydepwnsLiveview.Telemetry.Alerts do
  @moduledoc """
  ...
  defp get_metric_value(metric_name) do
    case metric_name do
      ...
      "hydepwns.socket.validation.error.count" ->
        try do
          error_count = HydepwnsLiveview.Telemetry.get_error_count()
          total_count = error_count + HydepwnsLiveview.Telemetry.get_success_count()
      ...
      "hydepwns_liveview.repo.query.total_time" ->
