defmodule HydepwnsLiveview.Utils.AshAdapter do
  @moduledoc """
  ...
  defmodule MyApp.UserResource do
    ...
    adapter HydepwnsLiveview.Utils.AshAdapter, schema: MyApp.UserResource
  end
  ```
  """

  @behaviour HydepwnsLiveview.Utils.ResourceAdapter

  alias HydepwnsLiveview.Utils.ResourceAdapter
