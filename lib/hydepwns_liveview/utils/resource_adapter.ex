defmodule HydepwnsLiveview.Utils.ResourceAdapter do
  @moduledoc """
  ...
  - `HydepwnsLiveview.Utils.EctoAdapter` - For Ecto schemas
  - `HydepwnsLiveview.Utils.AshAdapter` - For Ash resources (planned)
  - `HydepwnsLiveview.Utils.MemoryAdapter` - For in-memory data (for testing)
  ...
  def get_adapter(:ecto), do: HydepwnsLiveview.Utils.EctoAdapter
  def get_adapter(:ash), do: HydepwnsLiveview.Utils.AshAdapter
  def get_adapter(:memory), do: HydepwnsLiveview.Utils.MemoryAdapter
