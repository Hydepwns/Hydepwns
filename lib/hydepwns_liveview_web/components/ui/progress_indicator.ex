defmodule HydepwnsLiveviewWeb.Components.UI.ProgressIndicator do
  @moduledoc """
  ...
  attr :class, :string, default: "", doc: "additional CSS classes"
  attr :style, :string, default: "numbered", values: ["numbered", "dots", "arrows"], doc: "style of the step indicator"
  ...
  def step_indicator(assigns) do
    ...
    labels = if Enum.empty?(assigns.labels) do
  ...
  attr :frames, :list, default: ["⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"], doc: "animation frames"
  ...
  attr :class, :string, default: "", doc: "additional CSS classes"
  attr :style, :string, default: "braille", values: ["braille", "ascii", "dots", "line"], doc: "style of the spinner"

  def spinner(assigns) do
    # Set frames based on style if not explicitly provided
    frames = cond do
      assigns.frames != ["⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"] -> assigns.frames
      assigns.style == "ascii" -> ["/", "-", "\\", "|"]
      assigns.style == "dots" -> ["⣾", "⣽", "⣻", "⢿", "⡿", "⣟", "⣯", "⣷"]
      assigns.style == "line" -> ["▁", "▂", "▃", "▄", "▅", "▆", "▇", "█", "▇", "▆", "▅", "▄", "▃", "▂"]
      true -> ["⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"] # braille style (default)
    end
    
    assigns = assign(assigns, frames: frames)
    
    ~H"""
    <div id={@id} class={"monospace-progress spinner #{@style} #{@class}"} 
  ...
  attr :label, :string, default: nil, doc: "optional label to display with the progress"
  attr :class, :string, default: "", doc: "additional CSS classes"
  attr :size, :string, default: "medium", values: ["small", "medium", "large"], doc: "size of the circular indicator"
