defmodule HydepwnsLiveviewWeb.Examples.TransformationExampleLive do
  ...
  alias HydepwnsLiveview.Transformations.TransformationRegistry
      ...
      <div class="example-container">
        ...
        <div class="result-panel">
          ...
          <%= if @transformation_result do %>
            <.live_component module={HydepwnsLiveviewWeb.Components.TransformationVisualizerComponent} id="transformation_visualizer" context={@transformation_context} original_resource={@original_resource} transformed_resource={@resource} show_unchanged={false} collapsible={true} />
          <% else %>
