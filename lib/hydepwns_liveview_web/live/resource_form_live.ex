  ...
  def handle_event("save", %{"resource" => resource_params}, socket) do
    case ResourceSystem.create_resource(resource_params) do
      ...
      {:error, errors} ->
        ...
        error_map =
          Enum.group_by(errors, fn {field, _msg} -> field end, fn {_field, msg} -> msg end)
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <.form :let={_f} for={resource} phx-submit="save" class="max-w-lg mx-auto bg-white shadow-lg rounded-lg p-6">
        <div class="mb-4">
          ...
          <input type="text" name="resource[name]" id="resource_name" value={@resource.name} class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" data-test-id="name-input" required />
        ...
        <div class="mb-4">
          ...
          <textarea name="resource[description]" id="resource_description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" data-test-id="description-input" required><%= @resource.description %></textarea>
        ...
        <div class="mb-4">
          ...
          <input type="text" name="resource[type]" id="resource_type" value={@resource.type} class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" data-test-id="type-input" required />
        ...
        <div class="mb-4">
          ...
          <input type="text" name="resource[status]" id="resource_status" value={@resource.status} class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" data-test-id="status-input" />
        </div>
        ...
        <div class="mb-4">
          ...
          <select name="resource[parent_id]" id="resource_parent_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" data-test-id="parent-id-select">
        ...
        <div class="flex items-center justify-between">
          <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" data-test-id="save-resource">
            Create Resource
          </button>
          <.link navigate={~p"/resources"} class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
            Cancel
          </.link>
        </div>
      </.form>
