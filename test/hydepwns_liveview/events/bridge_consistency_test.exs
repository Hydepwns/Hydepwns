defmodule HydepwnsLiveview.Events.BridgeConsistencyTest do
  ...
  @bridge_mappings [
    ...
    {HydepwnsLiveview.Events.HandlerSupervisor,
     HydepwnsLiveview.Events.Handlers.HandlerSupervisor},
    {HydepwnsLiveview.Events.HandlerProcess, HydepwnsLiveview.Events.Handlers.HandlerProcess},
    {HydepwnsLiveview.Events.ProjectionSupervisor,
     HydepwnsLiveview.Events.Projections.ProjectionSupervisor},
    {HydepwnsLiveview.Events.EventSourcedResource,
     HydepwnsLiveview.Events.ResourceIntegration.EventSourcedResource}
  ]
