defmodule HydepwnsLiveview.Events.Core.EventInspectorTest do
  use HydepwnsLiveview.DataCase, async: true

  alias HydepwnsLiveview.Events.Core.EventInspector
  alias HydepwnsLiveview.Events.EventStore

  setup do
    # Set up test data
    test_event_1 = %HydepwnsLiveview.Events.Event{
      id: "event-1",
      type: "user.created",
    ...
    test_event_2 = %HydepwnsLiveview.Events.Event{
      id: "event-2",
      type: "user.updated",
    ...
    test_event_3 = %HydepwnsLiveview.Events.Event{
      id: "event-3",
      type: "user.deleted",
