defmodule HydepwnsLiveview.Events.EventSupervisorTest do
  use ExUnit.Case, async: false

  alias HydepwnsLiveview.Events.EventSupervisor
  alias HydepwnsLiveview.Events.Core.EventSupervisor, as: CoreEventSupervisor
  ...
  describe "core supervisor" do
    ...
    test "init/1 sets up all required children" do
      ...
      assert HydepwnsLiveview.Events.Core.EventBus in child_names
      assert HydepwnsLiveview.Events.Core.EventStore in child_names
      assert HydepwnsLiveview.Events.ProjectionSupervisor in child_names
      assert HydepwnsLiveview.Events.Handlers.HandlerSupervisor in child_names
      assert HydepwnsLiveview.Events.ProjectionRegistry in child_names
      assert HydepwnsLiveview.Events.HandlerRegistry in child_names
    end
  ...
  describe "registry setup" do
    test "creates handler registry" do
      ...
      assert Process.whereis(HydepwnsLiveview.Events.HandlerRegistry)
    end

    test "creates projection registry" do
      # Verify projection registry exists
      assert Process.whereis(HydepwnsLiveview.Events.ProjectionRegistry)
    end
  end
