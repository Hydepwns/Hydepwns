defmodule HydepwnsLiveviewWeb.Integration.PerformanceIntegrationTest do
  ...
  describe "Performance Monitoring" do
    test "tracks performance metrics", %{conn: conn} do
      ...
      HydepwnsLiveview.Performance.Monitor
      ...
      # Track the metric
      result = HydepwnsLiveview.Performance.Monitor.track_response_time("/health", response_time)
    ...
    test "detects performance degradation", %{conn: conn} do
      ...
      result = HydepwnsLiveview.Performance.Monitor.check_performance()
    ...
    test "generates performance reports", %{conn: conn} do
      ...
      result = HydepwnsLiveview.Performance.Monitor.generate_report("24h")
  ...
  describe "Performance Optimization" do
    test "implements caching for frequently accessed data", %{conn: conn} do
      # Mock caching
      HydepwnsLiveview.Performance.Cache
      |> expect(:get, fn key ->
      ...
      result = HydepwnsLiveview.Performance.Cache.get("resources:list")
