defmodule HydepwnsLiveview.TestSupport.EventTestHelper do
  @moduledoc """
  ...
  * `true` if the event matches expectations, raises an assertion error otherwise
  ...
  def assert_event_properties(event, expected_type, expected_resource_id, expected_data \\ %{}) do
    ...
    assert event.resource_id == expected_resource_id, "Expected resource ID #{expected_resource_id}, got #{event.resource_id}"
