defmodule HydepwnsLiveviewWeb.RenderHelper do
  @moduledoc """
  ...
  def render_component_in_liveview(conn, component_module, component_function, assigns) do
    ...
    defmodule HydepwnsLiveviewWeb.TestHelpers.ComponentWrapperLive do
    ...
    {:ok, view, _html} =
      live_isolated(
        conn,
        HydepwnsLiveviewWeb.TestHelpers.ComponentWrapperLive,
        session: %{
