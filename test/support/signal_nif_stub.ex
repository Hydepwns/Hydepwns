defmodule SignalNifStub do
  ...
  def generate_identity_key_pair do
    {:ok, %{public: "stub_public_key", private: "stub_private_key"}}
  end
  ...
  def generate_pre_key(_key_id) do
    {:ok, %{key_id: 1, public_key: "stub_pre_key"}}
  end
  ...
  def generate_signed_pre_key(_identity_key, _key_id) do
    {:ok, %{key_id: 1, public_key: "stub_signed_pre_key", signature: "stub_signature"}}
  end
